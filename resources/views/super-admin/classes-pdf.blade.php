    ...
    <div class="p-5 lg:p-10 overflow-hidden" >
        ...
        <div class="overflow-x-auto"  >
            <table class="w-full table border-separate border-spacing-y-2 md:border-spacing-y-5 overflow-x-scroll" style="min-width: 400px" >
                <x-tr class="">
                    <x-th class=" w-1/6 text-left"> Module Name</x-th>
                    <x-th class=" w-1/6 text-left ">Documents</x-th>
                    <x-th class="text-right" style="min-width: 80px">Action</x-th>
                </x-tr>
                <x-tr>
                    <x-td class=" w-1/6 text-left">
                        <div class="w-32 truncate"><a href="{{ route('super-admin.classes') }}">Frist module</a></div>
                    </x-td>
                    <x-td class=" w-1/3 text-left "><a href="{{ route('super-admin.classes') }}"> Course matriyal.pdf</a></x-td>
                    <x-td>
                        <a href="{{ route('super-admin.classes') }}" class="flex items-center justify-end">
                ...
                <x-tr>
                    <x-td class=" w-1/6 text-left">
                        <div class="w-32 truncate">lorem Basic</div>
                    </x-td>
                    <x-td class=" w-1/6 text-left ">
                        <div class="flex items-center gap-3 text-gray-400 ">
                            <svg viewBox="0 0 500 500" class="w-3 h-3">
                                <rect x="212" y="0" width="76" height="500" fill="#9ca3af"></rect>
                                <rect y="212" x="0" height="76" width="500" fill="#9ca3af"></rect>
                            </svg>
                            <span>Add</span>
                        </div>
                    </x-td>
                ...
                <x-tr>
                    <x-td class=" w-1/6 text-left">
                        <div class="w-32 truncate">exnal Basic</div>
                    </x-td>
                    <x-td class=" w-1/6 text-left">
                        <div class="flex items-center gap-3 text-gray-400 ">
                            <svg viewBox="0 0 500 500" class="w-3 h-3">
